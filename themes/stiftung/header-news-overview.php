...
<body>
    ...
    <header class="header news-overview-header" style="background-image: url(<?php the_post_thumbnail_url(); ?>);">
        <?php else : ?>
        <header class="header">
            ...
            <div class="container">
                ...
                <h1 class="news-overview-headline">
                    News
                </h1>
                <?php if ($header_text !== '') : ?>
                ...
                <div class="vc_btn3-container vc_btn3-inline header-button">
                    <a class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-square vc_btn3-style-modern vc_btn3-color-transparent text-white"
                        href="<?= $header_link_url ?>" title="<?= $header_link_title ?>"><?= 'mehr' ?></a>
                </div>
                <?php endif ?>
            </div>
