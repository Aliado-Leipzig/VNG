...
if ( in_array( $source, array( 'media_library', 'featured_image' ) ) && 'yes' === $add_caption ) {
	$post = get_post( $img_id );
        if(WPGlobus::Config()->language === 'ru' && $post->description_ru != ''){
            $caption = $post->description_ru;
        } else {
...
if ( in_array( $source, array( 'media_library', 'featured_image' ) ) && $single_image_show_description ) {
   
	$post = get_post( $img_id );
        if(WPGlobus::Config()->language === 'ru' && $post->content_ru != ''){
            $image_description = $post->content_ru;
        } else {
...
if ( 'yes' === $add_caption && '' !== $caption ) {
        $html .= '<div class="vc_figure-caption">' . esc_html( $caption ) . '</div>';
}

if ( $single_image_show_description && '' !== $image_description ) {
	$html .= '<div class="vc_figure-description">' . esc_html( $image_description ) . '</div>';
}
