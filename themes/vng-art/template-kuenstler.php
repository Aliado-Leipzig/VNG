<?php /* Template Name: Kuenstler Template */ get_header(); ?>
<main role="main">
                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper">
                        <span>
                            <?php
                            $lastLetter = "";
                            foreach (get_kuenstler_order_by_name() as $k ) {
                                if ($lastLetter != $k->surname[0]) {
                                    echo "<b class='alphabet-letter'>" . $k->surname[0] . " </b>";
                                }
                                $lastLetter = $k->surname[0];
                                echo "<a class='artist-list' href='" . get_permalink($k) . "'>" . $k->post_title . "</a> ";
                            }
                            ?>
                        </span>
					</div>
