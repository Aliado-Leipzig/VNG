<?php /* Template Name: Ausstellungen Template */ get_header(); ?>
    <main role="main">
            ...
            <div class="vc_row wpb_row vc_row-fluid margin-top-100">
                ...
                <div class="wpb_column vc_column_container vc_col-md-12 vc_col-lg-10">
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                            <?php
                            foreach (get_ausstellungen() as $ausstellung) {
                                echo generateVNGPreview(get_post_thumbnail_id($ausstellung->ID), $ausstellung->post_title, get_field('preview', $ausstellung), "mehr", get_post_permalink($ausstellung->ID), false);
                            }
                            ?>
                        </div>
                    </div>
