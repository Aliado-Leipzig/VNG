...
foreach ($images as $i => $image) {
    ...
    $image_description = '<div class="image-description">' . wp_get_attachment_caption($image) . '</div>';
    ...
    $gal_images .= $el_start . $link_start . $thumbnail .  $link_end . $image_description . $el_end;
}
